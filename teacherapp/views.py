...
def home(request):
    ...
    return render(request,'teacherapp/home.html',datadict)
...
def teacherlogin(request):
    if request.method == 'POST':
        ...
        con = dbConnection()
        cursor = con.cursor()
        result_count = cursor.execute('SELECT * FROM studenTachertbl WHERE employeerollno = %s AND upass = %s AND role=%s', (empno, password, urole))
        ...
        if result_count>0:
            ...
            return redirect('teaherindex')
        else:
            return render(request,'teacherapp/studlogin.html')
    return render(request,'teacherapp/studlogin.html')
...
def teacherregister(request):
    if request.method == 'POST':
        ...
        try: 
            ...
            dbClose()
        return render(request,'teacherapp/studlogin.html')
    return render(request,'teacherapp/studregister.html')
...
def teaherindex(request):
    if request.session.get('uname'):
        ...
        return render(request,'teacherapp/studindex.html',cartdict)
    return render(request,'teacherapp/studlogin.html')
...
def teacherprofile(request):
    if request.session.get('uname'):
        ...
        return render(request,'teacherapp/teacherprodile.html',cartdict)
    return render(request,'teacherapp/studlogin.html')
...
def teachermenu(request):
    if request.session.get('uname'):
        ...
        return render(request,'teacherapp/menu.html',datadict)
    return render(request,'teacherapp/studlogin.html')
...
def teacheraddtocart(request):
    if request.session.get('uname'):
        ...
        return render(request,'teacherapp/menu.html')
    return render(request,'teacherapp/studlogin.html')

###########################################################################################################################################
#                                                   Add and Remove from Cart
###########################################################################################################################################
def teachercartdata(request):
    if request.session.get('uname'):
        con = dbConnection()
        cursor = con.cursor()
        usrname = request.session['uname']
        ...
        cartdict = {"cartcount":len(res),
                    ...
                    "usrempno":empnos}
        return render(request,'teacherapp/cart.html',cartdict)
    return render(request,'teacherapp/studlogin.html')

def teacherremovecartdata(request):
    if request.session.get('uname'):
        if request.method == 'POST':
        ...
        return render(request,'teacherapp/cart.html')
    return render(request,'teacherapp/studlogin.html')
###########################################################################################################################################
#                                                   Checkout
###########################################################################################################################################

def teachercheckout(request):
    if request.session.get('uname'):
        if request.method == 'POST':
            #Parse form data    
            # print("hii register")
            ...
            if pmodes=="Card":
                cartdict = {"cartcount":len(res),
                            "dishPrice":dishPrice,
                            "usrempno":empnos}
                return render(request,'teacherapp/checkout1.html',cartdict)
            else:
                cartdict = {"cartcount":len(res),
                                "dishPrice":dishPrice,
                                "usrempno":empnos}
                return render(request,'teacherapp/checkout2.html',cartdict)
        return render(request,'teacherapp/checkout.html')
    return render(request,'teacherapp/studlogin.html')
...
#                                                   Add and Remove from Cart
###########################################################################################################################################
def teacherinvoicehistory(request):
    if request.session.get('uname'):
        con = dbConnection()
        cursor = con.cursor()
        usrname = request.session['uname']
        ...
        return render(request,"teacherapp/invoice.html",invoicedate)
    return render(request,'teacherapp/studlogin.html')
...
def teacherfeedback(request):
    if request.session.get('uname'):
        ...
        if request.method == 'POST':
            ...
            return render(request,"teacherapp/studfeedback.html",invoicedate)
        return render(request,"teacherapp/studfeedback.html",invoicedate)
    return render(request,'teacherapp/studlogin.html')
###########################################################################################################################################
#                                                   Send OTP
...
def sendotp(request):
    if request.method == 'POST':
        ...
        return render(request,"teacherapp/setpassword.html",otpdicts)
    return render(request,"teacherapp/studsendotp.html")
...
def setpassword(request):
    ...
    return render(request,"teacherapp/setpassword.html")
